...
<a onclick="stl_js.insertContent('[MM_Email_Name emailId=\'\']');" class="button-secondary">Insert Tag</a>

<h3>Description:</h3>
<p>This tag outputs either the default email name or the email name associated with the email account associated with the ID passed.</p>
