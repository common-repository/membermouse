<h2>[MM_Member_FirstName]</h2>

<a onclick="stl_js.insertContent('[MM_Member_FirstName]');" class="button-secondary">Insert Tag</a>

<h3>Description:</h3>
<p>This tag outputs the first name of the member associated with the ID passed, the member currently logged in or the member who's the recipient of an email being sent. Possible applications for this and other member data access tags are to display data on the screen, send as parameters to an external script to update a 3rd party database or to personalize email templates.</p>

<h3>Attributes:</h3>
<p><span class="mm-code">memberId</span> (optional) - Indicates the ID of the member to output the first name for.</p>
...
<p><span class="mm-code">[MM_Member_FirstName memberId="1"]</span></p>

<p><span class="mm-code">http://www.mydomain.com/scripts/updateMember.php?id=[MM_Member_ID /]&amp;...&amp;firstName=[MM_Member_FirstName]...</span></p>
